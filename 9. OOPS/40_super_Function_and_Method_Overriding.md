...
|----------|-------------|----------|
| **Purpose** | To call parent class methods or constructors | `super().method()` |
| **Used in** | Method overriding and inheritance chains | `super().__init__(args)` |
| **Avoids** | Code duplication and manual parent calls | Yes |
| **Works with** | Single, Multi-level, and Multiple Inheritance | ✅ |
| **Uses MRO** | Resolves parent methods automatically | ✅ |

---

### ⚙️ MRO Check (Method Resolution Order)
```python
print(Employee.mro())
```
...
- `super()` **automatically finds the next class** in the MRO chain — no need to hardcode parent names.
- In **multiple inheritance**, `super()` ensures **consistent and safe execution order**.
- Always prefer `super()` over direct parent class calls — especially in complex hierarchies.

---

✨ *“`super()` keeps your inheritance clean, organized, and future-proof.”* 🧬🐍
